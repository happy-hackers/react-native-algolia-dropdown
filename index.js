...
function validateChildProps(children) {
  if (children.isArray) {
    children.forEach((child) => {
      if (typeof child.props.index !== 'string')
        throw new Error(
          `AlgoliaDropdown: The child component ${child.type.name} must have an "index" attribute which is a string.`
        );
      if (typeof child.props.title !== 'string')
        throw new Error(
          `AlgoliaDropdown: The child component ${child.type.name} must have a "title" attribute which is a string.`
        );
      if (
        typeof child.props.params !== 'undefined' &&
        Object.prototype.toString.call(child.props.params) !== '[object Object]'
      )
        throw new Error(
          `AlgoliaDropdown: The child component ${child.type.name} has a params attribute which isn't an object.`
        );
    });
  } else {
    if (typeof children.props.index !== 'string')
      throw new Error(
        `AlgoliaDropdown: The child component ${children.type.name} must have an "index" attribute which is a string.`
      );
    if (typeof children.props.title !== 'string')
      throw new Error(
        `AlgoliaDropdown: The child component ${children.type.name} must have a "title" attribute which is a string.`
      );
    if (
      typeof children.props.params !== 'undefined' &&
      Object.prototype.toString.call(children.props.params) !==
        '[object Object]'
    )
      throw new Error(
        `AlgoliaDropdown: The child component ${children.type.name} has a params attribute which isn't an object.`
      );
  }
}
...
export default class AlgoliaDropdown extends Component {
      ...
      return this.setState({
        results: [
          this.props.noResultsWrapper ? (
            React.cloneElement(this.props.noResultsWrapper, {
              key: 'NoResults'
            })
          ) : (
        ...
        <View key={result.index}>
          {this.props.titleWrapper ? (
            result.hits.length === 0 ? null : (
              React.cloneElement(this.props.titleWrapper, {
                title: this.props.children.isArray
  ...
  handleTextChange(e) {
    if (e.nativeEvent.text === '') this.setState({ results: [] });
      ...
      this.client.search(
        this.formatQuery(e.nativeEvent.text),
        this.handleSearch
      );
  }
      ...
      <View style={[styles.container, this.props.style]}>
        ...
        <Animated.View
          style={{
            ...
            backgroundColor: this.props.resultsContainerBackgroundColor
          }}
        >
          {this.state.showOverlay === true ? (
            ...
            >
              ...
              {this.props.footerHeight ? (
                <View style={{ height: this.props.footerHeight }} />
              ) : null}
            </ScrollView>
          ) : null}
        </Animated.View>
